        ...
        <div className="mt-8 sm:mt-10 md:mt-16 flex flex-col lg:flex-row w-full justify-center items-center gap-6 sm:gap-8 md:gap-16">
          ...
          <div className="w-full lg:w-1/2 max-w-[500px]">
            <img
              src={ongoing}
              alt="Ongoing Event"
              className="w-full h-[250px] sm:h-[350px] md:h-[500px] object-cover rounded-lg 
          ...
          {/* Event Details */}
          <div className="flex flex-col gap-4 sm:gap-6 md:gap-8 w-full lg:w-1/2">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              {/* Event Details Box */}
              <div className="p-3 sm:p-4 text-center bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
            ...
            <Button className="bg-[#A7101F] text-lg sm:text-xl hover:bg-[#E4002A] w-full md:w-auto mx-auto
